...
public class User implements Serializable
{
    ...
    public User(String username, Address address, String password, String email, double balance, boolean isAdmin) {
    ...
    {
        if (!AttributeAccess.validatePassword(this, currentPassword)) {
    ...
    public String toString() {
        ...
        sb.append("\nis admin?=").append(isAdmin).append('\'');
        sb.append("\n}");
