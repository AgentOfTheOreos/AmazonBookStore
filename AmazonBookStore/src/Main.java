...
public class Main
{
    public static void main(String[] args)
    {
       /* User user = new User("AlanWake", new Address("Atlanta", "NJ", "Texas",
                "4585000"), "122344", "alanwake@gmail.com", 200.0, false);
        User user1 = new User("HaramSake", new Address("Nevada", "NY", "Texas",
                "4585000"), "122344", "alanwake@gmail.com", 1000.0, false);
        User user2 = new User("Harambote", new Address("ZooLand", "NoWhere", "Texas",
                "4585000"), "122344", "alanwake@gmail.com", 10000.0, true);
        ...
        MenuManager.displayWelcomeScreen();
