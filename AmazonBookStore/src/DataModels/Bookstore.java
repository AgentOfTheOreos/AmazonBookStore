...
import DataModels.Managers.FileHandler;
...
public class Bookstore implements Serializable
{
    ...
    public void loadBooksFromFile() {
        // This method is a modified version of the loadDecryptedObject method in the DataModels.Managers.FileHandler class, it simply loads
        // The saved books right back into the bookstore
    ...
    public void loadUsersFromFile() {
        // This method is a modified version of the loadDecryptedObject method in the DataModels.Managers.FileHandler class, it simply loads
        // The saved users right back into the bookstore
        ...
        if (loadedUsers != null) {
            ...
            System.out.println("Failed to load users from file UserLists/StoreUsers");
        }
    }
    public void saveUsersToFile() {
        // This method is a modified version of the saveEncryptedObject method in the DataModels.Managers.FileHandler class, it simply saves
        // The current users in the store into the appropriate filepath
        try {
    ...
    public void saveBooksToFile() {
        // This method is a modified version of the saveEncryptedObject method in the DataModels.Managers.FileHandler class, it simply saves
        // The current books in the store into the appropriate filepath
        try {
    ...
    public List<Book> searchBooksByRange(String category, int min, int max) {
        // This method simply returns a list of books that have a price/year that is between the maximum and minimum
        // given parameters
        List<Book> matchingBooks;
        switch (category) {
    ...
    public boolean purchaseBook(User user, Book book) {
        ...
        if (matchingBook == null) {
            System.out.println("Book does not exist in store :(. But not all is lost," +
                    " we're constantly adding new books to the store! :)");
        return false;
        }
    ...
    public boolean addToBasket(User user, Book book) {
        ...
        if (books.contains(book)) {
            ...
            System.out.println("The DataModels.Book has been added to the basket successfully! :)");
            return true;
        }
    ...
    public String toString() {
        ...
        sb.append("DataModels.Bookstore{\n");
